...
template<typename Kernel_traits, bool Is_dropout, bool Is_causal, bool Is_local, bool Has_alibi, bool Is_even_MN, bool Is_even_K, bool Return_softmax, bool Is_seq_len_headwise, typename Params>
inline __device__ void compute_attn_1rowblock(const Params &params, const int bidb, const int bidh, const int m_block) {
    ...
    const BlockInfo</*Varlen=*/!Is_even_MN, Is_seq_len_headwise> binfo(params, bidb, bidh);
...
inline __device__ void compute_attn_1rowblock_splitkv(const Params &params, const int bidb, const int bidh, const int m_block, const int n_split_idx, const int num_n_splits) {
    ...
    const BlockInfo</*Varlen=*/!Is_even_MN, false> binfo(params, bidb, bidh);
...
inline __device__ void compute_attn(const Params &params) {
    ...
    flash::compute_attn_1rowblock<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Is_even_MN, Is_even_K, Return_softmax, Is_seq_len_headwise>(params, bidb, bidh, m_block);
}
